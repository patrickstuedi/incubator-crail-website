...
<div style="text-align: justify"> 
<p>
The <a href="https://github.com/brianfrankcooper/YCSB">YCSB</a> benchmark is a popular benchmark to measure the performance of key-value stores in terms of PUT/GET latency and throughput for different workloads. We recently contributed support for Crail to the benchmark are we are excited that the Crail module got accepted and integrated into the benchmark last June. With Crail, users can now run NoSQL workloads over Crail's RDMA and NVMe-over-fabrics storage tiers. 
</p> 
</div>  

<div style="text-align: justify"> 
<p>
In order to run the benchmark simply clone the YCSB repository and build the Crail module as follows. 
</p> 
</div>   
