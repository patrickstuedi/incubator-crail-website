...
<p>
Recently, there has been an increased interest in disaggregated data shuffling. For instance, Riffle -- a research effort driven by Facebook -- is a shuffle implementation for Spark that is capabable of operating on disaggregated storage resources. Facebook's disaggregated shuffle engine has also been presented at SparkSummit'18 and SparkSummit'19 has another talk scheduled on this topic. In this blog, we discuss how shuffle disaggregation is done in Crail using RDMA accessible remote DRAM and NVMe flash. We also point out certain aspects where our approach differs from Riffle and Facebook's disaggregated shuffle manager. Some of the material of this blog has also been presented in previous talks on Crail, namely at SparkSummit'17 and SparkSummit'18. 
</p>
</div>
